...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    // Set up real-time listener for FIRs
    ...
    const unsubscribe = onSnapshot(q, (querySnapshot) => {
      try {
        ...
        console.error('Error processing FIRs:', error);
        toast.error('Failed to process FIR data');
        setLoading(false);
      }
    }, (error) => {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div className="mt-4 md:mt-0 flex space-x-2">
          <Link 
            to="/police/file-fir"
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 text-primary-foreground h-10 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        <div className="rounded-lg border bg-white text-card-foreground shadow-sm lg:col-span-2">
          <div className="flex flex-col space-y-1.5 p-6">
            <h3 className="text-2xl font-semibold leading-none tracking-tight">Recent FIRs</h3>
            <p className="text-sm text-gray-500">Recently filed complaints requiring attention</p>
          </div>
          <div className="p-6 pt-0">
                    ...
                    <tr key={fir.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-2 text-right">
                        <Link
                          ...
                          className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-gray-50 h-9 rounded-md px-3 text-blue-600"
                        >
                          View
                        </Link>
                      </td>
            ...
            <div className="mt-4 flex justify-center">
              <Link
                to="/police/all-firs"
                className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 h-9 rounded-md px-3"
              >
                View All FIRs
              </Link>
            </div>
        ...
        <div className="rounded-lg border bg-white text-card-foreground shadow-sm">
          <div className="flex flex-col space-y-1.5 p-6">
            ...
            <p className="text-sm text-gray-500">Overview of FIR status distribution</p>
          </div>
          <div className="p-6 pt-0">
